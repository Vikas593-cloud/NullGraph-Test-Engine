...
//
//     // 3. Setup Material (Using your built-in fallbacks!)
...
//     );
//
//     // 5. Setup Instance Data
//     const initialData = new Float32Array(STRIDE);
//
//     // Position
//     initialData[1] = 0.0;
//     initialData[2] = 0.0;
//     initialData[3] = 0.0; // Place exactly at center
//
//     // Rotation W (Identity)
//     initialData[7] = 1.0;
//
...
//
//     // 6. Return Loop for main.ts
//     return {
//         update: (simTime: number) => {
//             // The cube is static, so no need to update the Float32Array every frame
//         },
//         cameraUpdate: (cam: Camera, time: number) => {
//             // A nice slow orbit around the center (0,0,0) so we can see the PBR lighting catch the edges
//             const radius = 8;
//             cam.updateView(
...
//         },
//         destroy: () => {
//             // Clean up when switching demos
//             material.destroy();
//             cubeGeom.destroy();
//             engine.clearPasses();
//             console.log("Destroyed Hello Cube Demo");
//         }
//     };
