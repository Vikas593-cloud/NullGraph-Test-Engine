...
import {dynamicGeometryDocumentation} from "../demos/AxionEngineLoop/Documentation";
...
fn curve(uv: vec2<f32>) -> vec2<f32> {
  ...
  return new_uv * 0.5 + 0.5;
    ...
    "demo-axion-engine-loop":dynamicGeometryDocumentation,
    'demo-glb-loader':glbInstancingDocumentation,
    'demo-epic-swarm':epicSwarmDocumentation,
};